...
import { GreedyBestFirstAlgorithm } from "../js/algorithms/greedy-best-first.js";
...
test("Greedy Best-First finds a valid path toward a goal", () => {
  const algorithm = new GreedyBestFirstAlgorithm();
